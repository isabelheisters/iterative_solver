...
python = open("ergebnis_python_neu.txt", "r")
xpy1neu = []
ypy1neu = []
xpy2neu = []
ypy2neu = []
...
for line in python:
    array=line.split(";")
    if(array[0]=="100"):
        xpy1neu.append(array[1])
        ypy1neu.append(array[4])
    elif(array[0]=="200"):
        xpy2neu.append(array[1])
        ypy2neu.append(array[4])
    elif (array[0] == "400"):
        xpy3neu.append(array[1])
        ypy3neu.append(array[4])
    elif (array[0] == "800"):
        xpy4neu.append(array[1])
        ypy4neu.append(array[4])
    elif (array[0] == "1600"):
        xpy5neu.append(array[1])
        ypy5neu.append(array[4])

python.close()
julia = open("ergebnis_julia.txt", "r")
xjl1 = []
yjl1= []
xjl2 = []
yjl2= []
...
julia = open("ergebnis_julia_new.txt", "r")
xjlneu1 = []
yjlneu1= []
xjlneu2 = []
yjlneu2= []
...
for line in julia:
    array=line.split(";")
    if (array[0] == "100"):
        xjlneu1.append(array[1])
        yjlneu1.append(array[4])
    elif (array[0] == "200"):
        xjlneu2.append(array[1])
        yjlneu2.append(array[4])
    elif (array[0] == "400"):
        xjlneu3.append(array[1])
        yjlneu3.append(array[4])
    elif (array[0] == "800"):
        xjlneu4.append(array[1])
        yjlneu4.append(array[4])
    elif (array[0] == "1600"):
        xjlneu5.append(array[1])
        yjlneu5.append(array[4])
julia.close()
...
#pyplot.semilogx(xpy5,ypy5,"bx-", linewidth=2, markersize=10, label='Python 1600')
#pyplot.semilogx(xjl5, yjl5,"gx-", linewidth=2, markersize=10, label='Julia 1600')
...
pyplot.tight_layout()
pyplot.savefig('SORneu.png', transparent=True, bbox_inches='tight')