...
function jacobi(id::Int64, num_procs::Int64, x::Array{Float64,2},a::Array{Int64,1},b::Array{Float64,2},anzahl::Int64, w::Float64)
...
# 2-Dimensionaler Jacobi Algorithmus
# Schau in die Doku wenn du nicht weisst wies funktioniert!
function jacobi_mit_residuum(id::Int64, num_procs::Int64, x::Array{Float64,2},a::Array{Int64,1},b::Array{Float64,2},residuum::Float64, w::Float64)
    x=fuege_Rand_hinzu(x)
    b=fuege_Rand_hinzu(b)
    gr1=size(x)[1]
    gr2=size(x)[2]
...
function main(n::Int64, k::Int64)
    ...
    x=jacobi_mit_residuum(id,num_procs,x,A,b,0.1,2/3)
...
if(id==0)
   str= "Daten/jacobi_zweidimensional_$(num_procs).txt"
   datei=open(str,"w")
end
while n<5000
    if(id==0)
